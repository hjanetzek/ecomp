...
#define COMP_DISPLAY_OPTION_TEXTURE_FILTER                1
  //#define COMP_DISPLAY_OPTION_PING_DELAY		       2
...
typedef void (*HandleEcompEventProc) (CompDisplay *display,
				       char        *pluginName,
				       char        *eventName,
				       CompOption  *option,
				       int         nOption);
...
void
handleEcompEvent (CompDisplay *display,
		   char        *pluginName,
		   char        *eventName,
		   CompOption  *option,
		   int         nOption);
...
#define COMP_SCREEN_OPTION_DEFAULT_ICON		  5
#define COMP_SCREEN_OPTION_SYNC_TO_VBLANK	  6
...
#define HOME_PLUGINDIR ".ecomp/plugins"
