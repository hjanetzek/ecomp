...
#define HOME_METADATADIR ".ecomp/metadata"
		       ...
		       int  length)
{
    ...
    i = compReadXmlChunk ("<ecomp><plugin name=\"", &offset, buffer, length);
    ...
    i += compReadXmlChunk ("</plugin></ecomp>", &offset, buffer + i,
			   length - i);
				  ...
				  const char   *name)
{
    ...
    sprintf (str, "/ecomp/%s/screen//option[@name=\"%s\"]", m->path, name);
				   ...
				   const char	*name)
{
    ...
    sprintf (str, "/ecomp/%s/display//option[@name=\"%s\"]", m->path, name);
...
compGetShortPluginDescription (CompMetadata *m)
{
    ...
    sprintf (str, "/ecomp/%s/short/child::text()", m->path);
...
compGetLongPluginDescription (CompMetadata *m)
{
    ...
    sprintf (str, "/ecomp/%s/long/child::text()", m->path);
				     ...
				     CompOption   *o)
{
    ...
    sprintf (str, "/ecomp/%s/screen//option[@name=\"%s\"]/short/child::text()",
	     m->path, o->name);
				    ...
				    CompOption   *o)
{
    ...
    sprintf (str, "/ecomp/%s/screen//option[@name=\"%s\"]/long/child::text()",
	     m->path, o->name);
				      ...
				      CompOption   *o)
{
    ...
    sprintf (str,
	     "/ecomp/%s/display//option[@name=\"%s\"]/short/child::text()",
	     m->path, o->name);
				     ...
				     CompOption   *o)
{
    ...
    sprintf (str, "/ecomp/%s/display//option[@name=\"%s\"]/long/child::text()",
	     m->path, o->name);
