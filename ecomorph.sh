...
#	ECOMP_PLUGINS="$ECOMP_PLUGINS ccp"
#elif [ -f ${PLUGIN_PATH}libgconf.so ]; then
#	ECOMP_PLUGINS="$ECOMP_PLUGINS glib gconf"
#fi
ECOMP_PLUGINS="ccp" 
#ECOMP_PLUGINS="cube rotate scale decoration expo"
# get environment
build_env
build_args


#/usr/local/bin/ecomorph $ECOMP_OPTIONS "$@" $ECOMP_PLUGINS
#/home/jeff/src/compiz/src/
