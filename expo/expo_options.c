...
void
expoSetExpoInitiate(CompDisplay *d, CompActionCallBackProc init)
{
   EXPO_OPTIONS_DISPLAY(d);
...
void
expoSetExpoTerminate(CompDisplay *d, CompActionCallBackProc term)
{
   EXPO_OPTIONS_DISPLAY(d);
...
CompOption *
expoGetExpoOption(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
void
expoSetExpoNotify(CompDisplay *d, expoDisplayOptionChangeNotifyProc notify)
{
   EXPO_OPTIONS_DISPLAY(d);
...
void
expoSetNextInitiate(CompDisplay *d, CompActionCallBackProc init)
{
   EXPO_OPTIONS_DISPLAY(d);
...
void
expoSetNextTerminate(CompDisplay *d, CompActionCallBackProc term)
{
   EXPO_OPTIONS_DISPLAY(d);
...
CompOption *
expoGetNextOption(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
void
expoSetNextNotify(CompDisplay *d, expoDisplayOptionChangeNotifyProc notify)
{
   EXPO_OPTIONS_DISPLAY(d);
...
void
expoSetPrevInitiate(CompDisplay *d, CompActionCallBackProc init)
{
   EXPO_OPTIONS_DISPLAY(d);
...
void
expoSetPrevTerminate(CompDisplay *d, CompActionCallBackProc term)
{
   EXPO_OPTIONS_DISPLAY(d);
...
CompOption *
expoGetPrevOption(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
void
expoSetPrevNotify(CompDisplay *d, expoDisplayOptionChangeNotifyProc notify)
{
   EXPO_OPTIONS_DISPLAY(d);
...
int
expoGetDoubleClickTime(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
CompOption *
expoGetDoubleClickTimeOption(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
void
expoSetDoubleClickTimeNotify(CompDisplay *d, expoDisplayOptionChangeNotifyProc notify)
{
   EXPO_OPTIONS_DISPLAY(d);
...
CompOption *
expoGetZoomTimeOption(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
void
expoSetZoomTimeNotify(CompDisplay *d, expoDisplayOptionChangeNotifyProc notify)
{
   EXPO_OPTIONS_DISPLAY(d);
...
CompOption *
expoGetRotateOption(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
void
expoSetRotateNotify(CompDisplay *d, expoDisplayOptionChangeNotifyProc notify)
{
   EXPO_OPTIONS_DISPLAY(d);
...
Bool
expoGetExpoImmediateMove(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
CompOption *
expoGetExpoImmediateMoveOption(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
void
expoSetExpoImmediateMoveNotify(CompDisplay *d, expoDisplayOptionChangeNotifyProc notify)
{
   EXPO_OPTIONS_DISPLAY(d);
...
int
expoGetExpoAnimation(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
CompOption *
expoGetExpoAnimationOption(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
void
expoSetExpoAnimationNotify(CompDisplay *d, expoDisplayOptionChangeNotifyProc notify)
{
   EXPO_OPTIONS_DISPLAY(d);
...
Bool
expoGetReflection(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
CompOption *
expoGetReflectionOption(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
void
expoSetReflectionNotify(CompDisplay *d, expoDisplayOptionChangeNotifyProc notify)
{
   EXPO_OPTIONS_DISPLAY(d);
...
unsigned short *
expoGetGroundColor1(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
unsigned short
expoGetGroundColor1Red(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
unsigned short
expoGetGroundColor1Green(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
unsigned short
expoGetGroundColor1Blue(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
unsigned short
expoGetGroundColor1Alpha(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
CompOption *
expoGetGroundColor1Option(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
void
expoSetGroundColor1Notify(CompDisplay *d, expoDisplayOptionChangeNotifyProc notify)
{
   EXPO_OPTIONS_DISPLAY(d);
...
unsigned short *
expoGetGroundColor2(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
unsigned short
expoGetGroundColor2Red(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
unsigned short
expoGetGroundColor2Green(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
unsigned short
expoGetGroundColor2Blue(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
unsigned short
expoGetGroundColor2Alpha(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
CompOption *
expoGetGroundColor2Option(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
void
expoSetGroundColor2Notify(CompDisplay *d, expoDisplayOptionChangeNotifyProc notify)
{
   EXPO_OPTIONS_DISPLAY(d);
...
float
expoGetGroundSize(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
CompOption *
expoGetGroundSizeOption(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
void
expoSetGroundSizeNotify(CompDisplay *d, expoDisplayOptionChangeNotifyProc notify)
{
   EXPO_OPTIONS_DISPLAY(d);
...
CompOption *
expoGetDistanceOption(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
void
expoSetDistanceNotify(CompDisplay *d, expoDisplayOptionChangeNotifyProc notify)
{
   EXPO_OPTIONS_DISPLAY(d);
...
float
expoGetScaleFactor(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
CompOption *
expoGetScaleFactorOption(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
void
expoSetScaleFactorNotify(CompDisplay *d, expoDisplayOptionChangeNotifyProc notify)
{
   EXPO_OPTIONS_DISPLAY(d);
...
float
expoGetAspectRatio(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
CompOption *
expoGetAspectRatioOption(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
void
expoSetAspectRatioNotify(CompDisplay *d, expoDisplayOptionChangeNotifyProc notify)
{
   EXPO_OPTIONS_DISPLAY(d);
...
CompOption *
expoGetMipmapsOption(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
void
expoSetMipmapsNotify(CompDisplay *d, expoDisplayOptionChangeNotifyProc notify)
{
   EXPO_OPTIONS_DISPLAY(d);
...
int
expoGetMultioutputMode(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
CompOption *
expoGetMultioutputModeOption(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
void
expoSetMultioutputModeNotify(CompDisplay *d, expoDisplayOptionChangeNotifyProc notify)
{
   EXPO_OPTIONS_DISPLAY(d);
...
Bool
expoGetHideDocks(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
CompOption *
expoGetHideDocksOption(CompDisplay *d)
{
   EXPO_OPTIONS_DISPLAY(d);
...
void
expoSetHideDocksNotify(CompDisplay *d, expoDisplayOptionChangeNotifyProc notify)
{
   EXPO_OPTIONS_DISPLAY(d);
...
CompOption *
expoGetDisplayOption(CompDisplay *d, ExpoDisplayOptions num)
{
   EXPO_OPTIONS_DISPLAY(d);
   return &od->opt[num];
}
...
static Bool
expoOptionsSetDisplayOption(CompPlugin *plugin, CompDisplay *d, char *name, CompOptionValue *value)
{
   EXPO_OPTIONS_DISPLAY(d);
   CompOption *o;
   int index;
...
static CompOption *
expoOptionsGetDisplayOptions(CompPlugin *plugin, CompDisplay *d, int *count)
{
   EXPO_OPTIONS_DISPLAY(d);
...
static Bool
expoOptionsInitScreen(CompPlugin *p, CompScreen *s)
{
...
static void
expoOptionsFiniScreen(CompPlugin *p, CompScreen *s)
{
...
static Bool
expoOptionsInitDisplay(CompPlugin *p, CompDisplay *d)
{
...
static void
expoOptionsFiniDisplay(CompPlugin *p, CompDisplay *d)
{
